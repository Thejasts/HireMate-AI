...
import { UploadCloud, CheckCircle, AlertTriangle, BookOpen, Target, GraduationCap, Briefcase, ChevronRight, Video, Loader2 } from 'lucide-react';
          ...
          <form onSubmit={handleUpload} className="max-w-xl mx-auto">
            ...
            <div className="mb-6">
              <label 
                ...
                className={`relative block w-full p-8 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${
                  file 
              ...
              >
                <div className="text-center flex flex-col items-center">
                  ...
                  <span className={`mt-2 block text-sm font-medium ${file ? 'text-green-800 dark:text-green-400' : 'text-gray-900 dark:text-gray-100'}`}>
                    {file ? file.name : 'Click to select PDF resume'}
                  </span>
                  {!file && <span className="mt-1 block text-sm text-gray-500">PDF up to 5MB</span>}
                </div>
